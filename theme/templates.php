 ...
 <head>
   <meta charset="utf-8">
   <title>workwiz / <?php echo $title; ?></title>
     ...
     <header>
       <div class="topbar navbar-fixed-top">
         <div class="container">
           <div class="row">
             <div class="col-md-12">
               <p class="pull-left hidden-xs"><i class="fa fa-phone"></i>Tel No. 01-4311143</p>
       ...
       <div class="navbar navbar-default navbar-static-top">
         <div class="container">
           <div class="navbar-header">
             ...
             <a class="navbar-brand" href="<?php echo web_root; ?>index.php">Workwiz<!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
           </div>
           <div class="navbar-collapse collapse ">
             <ul class="nav navbar-nav">
               <li class="<?php echo !isset($_GET['q']) ? 'active' : '' ?>"><a href="<?php echo web_root; ?>index.php">Home</a></li>
               <!-- Recommendation button if the session is set -->
               <?php
                // Check if the 'APPLICANTID' session variable is set
                $showRecommendationButton = isset($_SESSION['APPLICANTID']);
                ?>

               <!-- ... Your other HTML code ... -->

               <?php if ($showRecommendationButton) : ?>
                 <li class="<?php echo isset($_GET['q']) ? 'active' : '' ?>">
                   <a href="<?php echo web_root; ?>index.php?q=recommend">Recommendation</a>
                 </li>
               <?php endif; ?>
         ...
         <div class="row">
           <div class="col-md-4 col-sm-4">
             <div class="widget">
               ...
               <p>
                 <i class="icon-phone"></i> 01-4311143<br>
